...
export function PlayerScreen({ navigation }: any) {
  ...
  const {
    ...
    shuffleMode, repeatMode, togglePlayPause, seekTo,
    skipToNext, skipToPrevious, toggleShuffle, cycleRepeatMode, addToQueue, playNext,
  } = usePlayer();
  ...
  return (
    <View style={[styles.container, { paddingBottom: insets.bottom, backgroundColor: Colors.background }]}>
      ...
      <View style={styles.mainControls}>
        <TouchableOpacity onPress={skipToPrevious} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
        ...
        >
          <Ionicons name="refresh-outline" size={28} color={Colors.textPrimary} style={{ transform: [{ scaleX: -1 }] }} />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={skipToNext} hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
      ...
      <View style={styles.secondaryControls}>
        ...
        <TouchableOpacity onPress={cycleRepeatMode} style={styles.secondaryBtn}>
          <Ionicons name={repeatIcon} size={24} color={repeatColor} />
        </TouchableOpacity>
      </View>

      {/* Lyrics button */}
      <TouchableOpacity style={styles.lyricsBtn} onPress={() => navigation.navigate("Queue")}>
...
const styles = StyleSheet.create({
  ...
  songName: { fontSize: FontSize.xl, fontWeight: FontWeight.bold, marginBottom: Spacing.xs },
  artistName: { fontSize: FontSize.md },
  seekBarWrapper: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm },
  mainControls: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  lyricsBtn: { alignItems: "center", paddingVertical: Spacing.md },
  lyricsText: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, marginTop: 2 },
});